...
private struct CurrentUserKey: EnvironmentKey {
    static let defaultValue: UserBase? = nil
}
...
extension View {
    ...
    func asyncAuthData(auth: Binding<Bool>, currentUser: Binding<UserBase?>) -> some View {
...
struct AsyncAuthData: ViewModifier {
    ...
    @Binding var currentUser: UserBase?
